...
true_align = 0
found = {}
with open("D:/Data/20170406/query_large_minimap_k13w2.out") as f1:
    for line in f1:
        line = line.rstrip()
        if line != "" and line[0]!="#":
            line_sp = line.split("\t")
...
true_align = 0
found = {}
with open("D:/Data/20170406/query_medium_minimap_k13w2.out") as f1:
    for line in f1:
        line = line.rstrip()
        if line != "" and line[0]!="#":
            line_sp = line.split("\t")
...
true_align = 0
found = {}
with open("D:/Data/20170406/query_small_minimap_k13w2.out") as f1:
    for line in f1:
        line = line.rstrip()
        if line != "" and line[0]!="#":
            line_sp = line.split("\t")
