...
group_output = []
found = {}
with open("D:/Data/20170727/query_all_processe_0p85_0p12_5_1.out") as f1:
    for line in f1:
        line = line.rstrip()
...
with open("D:/Data/20170727/yass_chain_compare_with_minimap_9mer_0.85_5_1.out", "w") as fout:
