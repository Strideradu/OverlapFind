...
group_output = []
found = {}
with open("D:/Data/20170727/query_all_processe_0p75_0p2_3_1.out") as f1:
    for line in f1:
        line = line.rstrip()
...
with open("D:/Data/20170727/yass_chain_compare_with_minimap_9mer_0p75_0p2_3_1.out", "w") as fout:
