...
group_output = []
with open("D:/Data/20170426/medium_13mer_0.85_0.12_3_align_found.out") as f1:
    for line in f1:
        line = line.rstrip()
        if line != "" and line[0]!="#":
            line_sp = line.split("\t")
...
with open("D:/Data/20170426/medium_compare_with_minimap_0.85_0.12_3.out", "w") as fout:
